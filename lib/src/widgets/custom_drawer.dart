...
class FancyZoomDrawer extends StatefulWidget {
  const FancyZoomDrawer({
    Key? key,
  ...
  @override
  _FancyZoomDrawerState createState() => _FancyZoomDrawerState();

  /// static function to provide the drawer state
  static _FancyZoomDrawerState? of(BuildContext context) {
    return context.findAncestorStateOfType<State<FancyZoomDrawer>>()
    as _FancyZoomDrawerState?;
  }
}

class _FancyZoomDrawerState extends State<FancyZoomDrawer>
  ...
  @override
  void didUpdateWidget(covariant FancyZoomDrawer oldWidget) {
